...
public class DataMigrationService {
  ...
  public DataMigrationService(
      @Value("${elmify.migration.source.endpoint}") String sourceEndpoint,
      @Value("${elmify.migration.source.access-key:#{null}}") String sourceAccessKey,
      @Value("${elmify.migration.source.secret-key:#{null}}") String sourceSecretKey,
      @Value("${elmify.migration.source.bucket:elmify-audio}") String sourceBucket,
      @Value("${elmify.r2.endpoint}") String targetEndpoint,
      @Value("${elmify.r2.access-key}") String targetAccessKey,
      @Value("${elmify.r2.secret-key}") String targetSecretKey,
      @Value("${elmify.r2.bucket-name}") String targetBucket) {
